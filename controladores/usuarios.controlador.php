		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
			   	...
			   	$encriptar = crypt($_POST["regPassword"], '$2a$07$5s2b3ep6q8gkh7m0plk2juv3f$');
		...
		if(isset($_POST["ingEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["ingEmail"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				$encriptar = crypt($_POST["ingPassword"], '$2a$07$5s2b3ep6q8gkh7m0plk2juv3f$');
	...
	public function ctrOlvidoPassword(){
		...
		if(isset($_POST["passEmail"])){
			...
			if(preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["passEmail"])){
				...
				$encriptar = crypt($nuevaPassword, '$2a$07$5s2b3ep6q8gkh7m0plk2juv3f$');
	...
	static public function ctrRegistroRedesSociales($datos){
		...
		if($emailRepetido || $respuesta1 == "ok"){
           ...
           echo json_encode($sasa);
			 ...
			 $sasa = array("respuesta" => "");
          return json_encode($sasa);
			}
	...
	public function ctrActualizarPerfil(){
		...
		if(isset($_POST["editarNombre"])){
			...
			if($_POST["editarPassword"] == ""){
				...
				$password = crypt($_POST["editarPassword"], '$2a$07$5s2b3ep6q8gkh7m0plk2juv3f$');
...
static	public function ctrInsertarComentarioNuevaCompra($datos){

$tabla = "comentarios";

$respuesta = ModeloUsuarios::mdlInsertarComentarioNuevaCompra($tabla , $datos);
...
return $respuesta;
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->setFrom('ammu@ammu.com.ar' , 'Ammu Ecommerce');

					$mail->addReplyTo('ammu@ammu.com.ar' , 'Ammu Ecommerce');

					$mail->Subject = "Ha recibido una consulta";

					$mail->addAddress("franamuchastegui@gmail.com");
	...
	static public function ctrNuevoReporte($datosReporte){


   $tabla = "reportes";

    $respuesta = ModeloUsuarios::mdlNuevoReporte($tabla , $datosReporte);
