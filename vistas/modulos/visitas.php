	...
	<div class="container">
		<div class="row">
           ...
           <?php 
            ...
            $coloresPiases = array("#09F" , "#900" , "#059" , "#260" , "#F09" , "#02A");
            ...
            foreach ($paises as $key => $value) {
				...
				<input type="text" class="knob" value="'.round($promedio).'" data-width="90" data-height="90" data-fgcolor="'.$coloresPiases[$indice].'" data-readonly="true" name="">
