					...
					<div class="col-xs-12 organizarProductos">
						...
						<div class="btn-group pull-right">
							 ...
							 <button type="button" class="btn btn-default btnGrid" id="btnGrid'.$i.'">
								...
								<span class="col-xs-0 pull-right"> GRILLA</span>
					...
					echo '<li class="col-md-3 col-sm-6 col-xs-12">
								...
								<small>
									...
									<a href="'.$value["ruta"].'" class="pixelProducto">
										...
										if($value["oferta"] != 0 && $value["precio"] != 0){
											...
											if($value["stock"] < 10  &&  $value["stock"] > 0){

											echo '<span class="label label-warning fontSize">¡Últimas '.$value["stock"].' unidades!</span> ';

										}

										if($value["stock"] == 0 ){

											echo '<span class="label label-danger fontSize">Sin Stock</span> ';
							...
							<div class="col-xs-6 enlaces">
								...
								<div class="btn-group pull-right">
									...
									if($value["tipo"] == "virtual" && $value["precio"] != 0 &&  $value["stock"] > 0){
