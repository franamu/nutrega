					...
					if($infoproducto["oferta"] == 0){
						...
						if($fechaNueva > $infoproducto["fecha"]){
							...
							<small>
								...
								if($infoproducto["stock"] < 10 && $infoproducto["stock"] > 0){

								echo '<span class="label label-warning">Quedan '.$infoproducto["stock"].' unidades</span> ';
							}

								if($infoproducto["stock"] == 0){

								echo '<span class="label label-danger">Sin stock</span> ';
							}
						...
						if($fechaNueva > $infoproducto["fecha"]){
							...
							if($infoproducto["stock"] < 10){
								...
								echo '<span class="label label-warning">Quedan '.$infoproducto["stock"].' unidades</span> </small>';
							}
