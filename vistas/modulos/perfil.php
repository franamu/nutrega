    ...
    foreach ($compras as $key => $value1) {
        ...
        foreach ($productos as $key => $value2) {
            echo '<div class="panel panel-default">
              ...
              <p><small>' . $value2["titular"] . '</small></p>';

            if ($value2["tipo"] == "virtual") {

                echo '<a href="' . $url . 'curso/'.$value1["id"].'/'.$value1["id_usuario"].'/'.$value1["id_producto"].'/'.$value2["ruta"].'"> <button class="btn btn-default pull-left">Ir al curso</button> </a>';
            } else {
                ...
                if ($value1["envio"] == 0) {
                 ...
                 <i class="fa fa-clock-o"></i> En camino
                 </div>
                ...
                if ($value1["envio"] == 1) {
                 ...
                 <div class="progress-bar progress-bar-default" role="progressbar" style="width:33.33%">
                 <i class="fa fa-check"></i> En camino
                 </div>
            ...
            echo '
                 ...
                 <h4 class="pull-right"><small>Comprado el ' . substr($value1["fecha"], 0, -8) . ' a las ' . substr($value1["fecha"], 10, 6) . ' hs</small></h4>
            ...
            echo '
                          ...
                          <small>' . $comentarios["comentario"] . '</small>
                          </p>
                       </div>
...
if (!$deseos) {
    ...
    echo '<div class="col-12-xs text-center error404">
                <h1><small>¡Oops!</small></h1>
                <h2>Aún no tienes productos en tu lista de deseos</h2>
    ...
    foreach ($deseos as $key => $value1) {
        ...
        <div class="col-xs-6 precio">';
            ...
            if ($value2["precio"] == 0) {
              ...
              <strong class="oferta" style="font-size:11px;">$' . $value2["precio"] . '</strong>
          ...
          <div class="btn-group pull-right">
            ...
            if ($value2["tipo"] == "virtual" && $value2["precio"] != 0) {
                ...
                if ($value2["precio"] != 0) {
                    ...
                    echo '<button style="margin-top:-2px;" type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="' . $value2["id"] . '" imagen="' . $servidor . $value2["portada"] . '" titulo="' . $value2["titulo"] . '"precio="' . $value2["precioOferta"] . '" tipo="' . $value2["tipo"] . '" peso="' . $value2["peso"] . '" data-toggle="tooltip" title="Agregar al carrito de compras">
                ...
                <i class="fa fa-shopping-cart" aria-hidden="true"></i>
                    ...
                    echo '<button style="margin-top:-2px;"  type="button" class="btn btn-default btn-xs agregarCarrito"  idProducto="' . $value2["id"] . '" imagen="' . $servidor . $value2["portada"] . '" titulo="' . $value2["titulo"] . '"precio="' . $value2["precio"] . '" tipo="' . $value2["tipo"] . '" peso="' . $value2["peso"] . '" data-toggle="tooltip" title="Agregar al carrito de compras">
            ...
            <a href="' . $url . $value2["ruta"] . '" class="pixelProducto">
              ...
              <button style="margin-top:-2px;" type="button" class="btn btn-default btn-xs" data-toggle="tooltip" title="Ver producto">
...
<!--====  End of VENTANA MODAL COMENTARIOS  ====-->
