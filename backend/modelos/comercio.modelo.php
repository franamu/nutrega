...
/*=====  End of ACTUALIZAR LOGO  ======*/
	...
	static public function mdlActualizarInformacion($tabla, $id, $datos){
		...
		modoPaypal = :modoPaypal, estadoPaypal = :estadoPaypal, clienteIdPaypal = :clienteIdPaypal, llaveSecretaPaypal = :llaveSecretaPaypal, modoPayu = :modoPayu, estadoPayu = :estadoPayu, merchantIdPayu = :merchantIdPayu, accountIdPayu = :accountIdPayu, apiKeyPayu = :apiKeyPayu WHERE id = :id");
		...
		$stmt->bindParam(":estadoPaypal", $datos["estadoPaypal"], PDO::PARAM_STR); 
		...
		$stmt->bindParam(":estadoPayu", $datos["estadoPayu"], PDO::PARAM_STR);
