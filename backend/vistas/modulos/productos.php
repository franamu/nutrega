        ...
        <div class="modal-body">
          ...
          <div class="box-body">
           ...
           <!--=====================================
            ...
            <!--=====================================
            AGREGAR PRECIO, STOCK  PESO Y ENTREGA
            ======================================-->
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg stock" min="0" step="any">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4 col-xs-12">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control input-lg editarStock" min="0" step="any">
