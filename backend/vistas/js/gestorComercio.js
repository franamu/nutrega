...
$("input[name='modoPaypal']").on("ifChecked",function(){
	...
	var estadoPayu = $("input[name='estadoPayu']:checked").val();
	var estadoPaypal = $("input[name='estadoPaypal']:checked").val();

	$("#guardarInformacion").click(function(){

		cambiarInformacion(modoPaypal, modoPayu , estadoPaypal, estadoPayu);
...
/*=============================================
CAMBIAR ESTADO PAYPAL
=============================================*/
$("input[name='estadoPaypal']").on("ifChecked",function(){

	var estadoPaypal = $(this).val();
	var estadoPayu = $("input[name='estadoPayu']:checked").val();
	var modoPaypal = $("input[name='modoPaypal']:checked").val();
	var modoPayu = $("input[name='modoPayu']:checked").val();
...
$("input[name='estadoPayu']").on("ifChecked",function(){

	var estadoPayu = $(this).val();
	var estadoPaypal = $("input[name='estadoPaypal']:checked").val();
	var modoPaypal = $("input[name='modoPaypal']:checked").val();
	var modoPayu = $("input[name='modoPayu']:checked").val();
...
$(".cambioInformacion").change(function(){
	...
	estadoPaypal = $("input[name='estadoPaypal']:checked").val();
	...
	estadoPayu = $("input[name='estadoPayu']:checked").val();
...
function cambiarInformacion(modoPaypal, modoPayu , estadoPaypal, estadoPayu){
	...
	datos.append("estadoPaypal", estadoPaypal);	
	...
	datos.append("estadoPayu", estadoPayu);	
