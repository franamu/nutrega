...
ACTIVAR PRODUCTO
=============================================*/
$('.tablaProductos tbody').on("click", ".btnActivarProductos", function(){
...
function agregarMiProducto(imagen){
	    ...
	    if(seleccionarTipo == "virtual"){
			...
			var detalles = {"Marca": $(".detalleMarca").tagsinput('items')};
		...
		$.ajax({
				...
				success: function(respuesta) {
					...
					} else if (respuesta == "ERR100") {
						swal("Título", "El único caracter especial permitido es el punto (.)", "error");
...
$('.tablaProductos tbody').on("click", ".btnEditarProducto", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#modalEditarProducto .editarStock").val(respuesta[0]["stock"]);
			...
			$(".guardarCambiosProducto").click(function(){
					...
					if($("#modalEditarProducto .tituloProducto").val() != "" && 
					   ...
					   $("#modalEditarProducto .editarStock").val() != "" &&
					...
					setTimeout(function(){
	    				...
	    				var stock = $("#modalEditarProducto .editarStock").val();
    				  	...
    				  	if(seleccionarTipo == "virtual"){
							...
							var detalles = {"Marca": $("#modalEditarProducto .detalleMarca").tagsinput('items')};
