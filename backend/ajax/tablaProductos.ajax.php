...
class TablaProductos {
  ...
  /*================================================
  =            METODO PARA PARAGRAFIZAR            =
  ================================================*/
    static public function paragrafizar($string) {
  ...
  /*=====  End of METODO PARA PARAGRAFIZAR  ======*/
          	...
          	$datosJson = '
        	 	...
        	 	for($i = 0; $i < count($productos); $i++) {
        			...
        			/*=============================================
          			...
          			$estado = "<button class='btn btn-xs btnActivarProductos ".$colorEstado."' idProducto='".$productos[$i]["id"]."' estadoProducto='".$estadoProducto."'>".$textoEstado."</button>";
                    ...
                    /*================================================
                    =            PARAGRAFIZAR DESCRIPCION            =
                    ================================================*/
                        
             

                   $crearParaffos = new TablaProductos();
                   $descripcion = $crearParaffos->paragrafizar($cabeceras["descripcion"]);
          
                
                    /*=====  End of PARAGRAFIZAR DESCRIPCION  ======*/
